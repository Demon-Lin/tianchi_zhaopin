# -*- coding: utf-8 -*-
"""
Created on Sun Jul 21 14:21:20 2019
...
test_raw_data=pd.read_table('dataset/table1_user')
...
process_data2=pd.merge(process_data1,tmp_df,on='user_id',how='left')
process_data2.fillna(0,inplace=True)

process_data2.to_csv('user_data_processed_2.csv',index=False)
